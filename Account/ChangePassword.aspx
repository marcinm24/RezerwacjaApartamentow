...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        Użyj poniższego formularza aby zmienić hasło.
    </p>
    <p>
        Nowe hasło wymaga minimum <%= Membership.MinRequiredPasswordLength %> znaków długości.
    </p>
                ...
                <fieldset class="changePassword">
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="CurrentPasswordRequired" runat="server" ControlToValidate="CurrentPassword" 
                             CssClass="failureNotification" ErrorMessage="Hasło jest wymagane." ToolTip="Old Password is required." 
                    ...
                    <p>
                        ...
                        <asp:RequiredFieldValidator ID="NewPasswordRequired" runat="server" ControlToValidate="NewPassword" 
                             CssClass="failureNotification" ErrorMessage="Nowe hasło jest wymagane." ToolTip="New Password is required." 
                             ValidationGroup="ChangeUserPasswordValidationGroup">*</asp:RequiredFieldValidator>
                    </p>
                    <p>
                        ...
                        <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="NewPassword" ControlToValidate="ConfirmNewPassword" 
                             CssClass="failureNotification" Display="Dynamic" ErrorMessage="Nowe hasła muszą być identyczne aby dokonać zmian."
